        ...
        add_node: function (parent_node, nodeid, topic, data, idx, direction, expanded) {
            ...
            if (parent_node.isroot) {
                ...
                if (isNaN(direction)) {
                    ...
                    // d = (children_len > 1 && r > 0) ? jm.direction.left : jm.direction.right; //修改在右边
                    d = 1
                } else {
                    //d = (direction != jm.direction.left) ? jm.direction.right : jm.direction.left;//修改在右边
                    d = 1
                }
    ...
    jm.format = {
        ...
        node_array: {
            example: {
                ...
                "format": "node_array",
                "data": [
                    { "id": "root", "topic": "请选择api", "isroot": true }
                ]
            },
